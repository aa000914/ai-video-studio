...
const CHARACTERS = [
  {
    ...
    role: "主角",
    age: "28岁",
    personality: "前秦国贵族后裔，才华横溢但隐姓埋名。外表谦和温润如玉，内心却藏着复国之志与对真相的执念。精通儒墨两家之学，世称'布衣奇士'",
  ...
  },
  {
    ...
    role: "重要配角",
    age: "45岁",
    personality: "沉稳威严的秦国君主，表面不苟言笑实则求贤若渴。对扶苏既严厉又寄予厚望，暗中关注着天下隐士的动向",
  ...
  },
  {
    ...
    role: "配角",
    age: "62岁",
    personality: "李斯同门师兄，博学多识，明哲保身。外表圆滑世故，实则在关键时刻会坚守大义。是李天行寻找的历史真相的关键知情人",
